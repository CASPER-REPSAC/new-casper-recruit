...
function Section2({ scrollY }: ISectionProps) {
  ...
  const x1 = useTransform(scrollRatio, [0.1, 0.2, 0.25, 0.3], [50, 0, 0, -50]);
  const x2 = useTransform(scrollRatio, [0.3, 0.4, 0.45, 0.5], [50, 0, 0, -50]);
  const x3 = useTransform(scrollRatio, [0.5, 0.6, 0.65, 0.7], [50, 0, 0, -50]);
  const x4 = useTransform(scrollRatio, [0.7, 0.8, 0.85, 0.9], [50, 0, 0, -50]);
      ...
      <StickyBody>
        ...
        <Item style={{ opacity: opacity1, x: x1 }}>
          ...
          <Message>
            ...
            <H4>Beginnings</H4>
            <P>
              2000년 5월 1일 이종근 교수님 아래서 창단된 정보보호 동아리입니다.
              보안과 관련된 여러 가지 분야에 대해 학습하며, 학습한 내용에 대한
              내부세미나를 실시하여 동아리원이 같이 성장해 나가고 있습니다.
              현재는 차정원 교수님의 지도아래 있습니다
            </P>
          </Message>
        </Item>
        ...
        <Item style={{ opacity: opacity3, x: x3 }}>
          ...
          <Message>
            ...
            <P>
              ...
              연합으로써 매년 2회 씩 정기 워크샵을 개최해 다양한 정보보호 기술을
              공유하고 있습니다. 또한 참여대학간의 교류 증진을 위해 여러가지
              커뮤니티 활동을 하고 있습니다.
            </P>
          </Message>
        </Item>
        ...
        <Item style={{ opacity: opacity4, x: x4 }}>
          ...
          <Message>
            ...
            <H4>Join KUCIS</H4>
            <P>
              한국인터넷진흥원(KISA)에서 발주한 사업으로 40여개의 전국 정보보호
              동아리로 구성되어 있으며, 현재까지 KUCIS로 부터 여러가지 지원과,
              교육 및 세미나 등을 제공받고 있습니다.
            </P>
          </Message>
        </Item>
      </StickyBody>
